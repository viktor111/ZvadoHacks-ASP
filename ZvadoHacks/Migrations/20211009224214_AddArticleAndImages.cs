...
{
    public partial class AddArticleAndImages : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleFullscreenContent = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ArticlePreviewContent = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
